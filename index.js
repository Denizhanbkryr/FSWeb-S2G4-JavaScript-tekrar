...
// ucetambolunenler adında yeni bir dizi oluşturuyoruz
var ucetambolunenler = [];
...
var siralisayilar = besyuzdenkucuksayilar.sort(
  (buyuksayi, kucuksayi) => buyuksayi - kucuksayi
);
...
console.log(tekrarSayilari(sayilar));
